# Generated by Django 3.0.5 on 2024-05-22 20:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=40)),
                ('mobile', models.CharField(max_length=20, null=True)),
                ('department', models.CharField(choices=[('Mathematics', 'Mathematics'), ('Literature', 'Literature'), ('Biology', 'Biology'), ('Chemistry', 'Chemistry'), ('Physic', 'Physic'), ('Software', 'Software')], default='Mathematics', max_length=50)),
                ('status', models.BooleanField(default=False)),
